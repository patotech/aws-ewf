...
The lambda project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=lambda -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3.1 -DgroupId=cl.aws.demo -Dversion=1.0.0-SNAPSHOT -Dinteractive=false
$ cd lambda
$ mvn clean package
