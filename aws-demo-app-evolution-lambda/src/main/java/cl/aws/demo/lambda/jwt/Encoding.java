 ...
 * @see https://www.programcreek.com/java-api-examples/?code=trajano/openid-connect/openid-connect-master/openid-connect-core/src/main/java/net/trajano/openidconnect/crypto/RsaWebKey.java#
 */
public final class Encoding {
    ...
    public static String base64Encode(final String s) {
        ...
        return base64Encode(s.getBytes(CharSets.UTF8), 0, s.getBytes(CharSets.UTF8).length, true);
    }
    ...
    public static String base64EncodeAscii(final String s) {
        ...
        return base64urlEncode(s.getBytes(CharSets.US_ASCII));
    }
    ...
    public static String base64urlDecodeToString(final String encoded) {
        ...
        return new String(base64urlDecode(encoded), CharSets.UTF8);
    }
    ...
    public static String base64urlEncode(final String s) {
        ...
        return base64urlEncode(s.getBytes(CharSets.UTF8));
    }
